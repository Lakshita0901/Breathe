  ...
  return (
    <div className="fade-in min-h-screen flex flex-col items-center justify-center px-4 py-12">
      <div className="max-w-2xl w-full text-center">
        <p className="text-breathe-green font-medium text-sm tracking-wider uppercase mb-3">Breathe</p>
            ...
            <div className="flex items-baseline justify-between">
              <div>
                <p className="text-2xl font-bold text-gray-800">
                  {Math.round(latest.total)} <span className="text-sm font-normal text-gray-400">kg CO&#8322;/mo</span>
                </p>
          ...
          {countryKeys.map((code) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-gray-400 text-xs mt-1">avg {c.avgFootprint} kg CO&#8322;/mo</p>
              </button>
            );
          })}
        </div>
